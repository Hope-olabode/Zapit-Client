...
import SelectedIssueD from "./SelectedIssueD";
...
export default function LoadedIssues() {
  ...
  const logsFilteredIssues = filteredIssues;
    ...
    <div className="scrollbar-hide">
      <div className="absolute mt-[88px]  lg:mt-0 w-full right-[50%] translate-x-[50%] z-5 lg:w-[calc(100%-184px)] lg:right-10 lg:translate-x-0 flex ">
        ...
        >
          ...
          {/* Stats bar */}
          <div className="h-[120px] my-8 px-4 lg:px-0 lg:w-[512px] ">
          ...
          <div className="mb-4  justify-between px-4 hidden lg:flex ">
            <p className="font-benton-black text-[14px] leading-[150%] w-[10%] pl-5">
              --
            </p>
            <p className="font-benton-black text-[14px] leading-[150%] w-[30%]">
              Description
            </p>
            <p className="font-benton-black text-[14px] leading-[150%] w-[20%] text-center">
              Category
            </p>
            <p className="font-benton-black text-[14px] leading-[150%] w-[20%] text-right pr-10">
              Status
            </p>
            <p className="font-benton-black text-[14px] leading-[150%] w-[20%] text-center">
              Urgency
          ...
          {isDesktop ? (
            <div className="">
              {filteredIssues.length != 0 ? (
                <div className="w-full border-2 rounded-[16px] overflow-hidden bg-[#F6F7F9] ">
                  {filteredIssues.map((issue, index) => {
                    const isLast = index === issue.length - 1;
                    return (
                      <div
                        key={index}
                        onClick={() => {
                      ...
                      >
                        <div className="flex items-center gap-8 w-[65%]">
                          <div className="w-12 h-12 border rounded-[8px] flex-shrink-0 overflow-hidden">
                            <img
                              className="w-full h-full"
                              src={issue.images[0].url}
                            />
                          </div>
                          <div className="w-[200%] truncate">
                              ...
                              <div
                                ...
                                className={` ${
                                  index === issues.length - 1
                                    ? "top-[-140px]"
                                    : "top-0"
                                } left-[0px] z-30 absolute`}
                              >
                                <div className="w-[200px] fixed lg:absolute pb-2 z-40 h-[150px] bg-[#F6F6F6] rounded-[14px] border-1 border-gray-800 shadow-lg overflow-hidden">
                                  {/* Header */}
                                    ...
                                    <div className="p-2 rounded-b-3xl">
                                      <div className="flex flex-wrap gap-3">
                                        {categories.map((category) => (
                                          ...
                                          >
                                            <span
                                              className="text-[12px] font-sans leading-[16px] font-semibold"
                        ...
                        <div className="flex gap-2 w-[35%] justify-evenly">
                          <div
                            className={`${"px-2"} border rounded-[72px] flex justify-center items-center  ${
                          ...
                          >
                            <p className="font-sans font-semibold text-[12px] leading-[16px] tracking-[-0.5px]">
                              {issue.status}
                            </p>
                          </div>
                          <div
            ...
            <div className=" px-4 lg:px-0  mb-[150px]">
      ...
      {isDesktop ? "" : selectedIssue && <SelectedIssue />}
      {}
    </div>
  );
}
